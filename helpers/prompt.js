export const generatePrompt = (query) => {
  ...
  -Name Style: ${query?.nameStyle || "Auto"}
  -Randomness: ${query?.randomness || "Low"}
  -Brand Info: keyword: ${query?.keyword || "Coding"} & description:  ${
    query?.description || "A Coding YouTube Channel"
  }
